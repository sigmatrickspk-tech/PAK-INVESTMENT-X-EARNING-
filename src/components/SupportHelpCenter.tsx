...
// Web Audio API sound synthesizer for subtle admin reply notification
function playAdminMessageChime() {
  try {
...
export const SupportHelpCenter: React.FC = () => {
  ...
  // Track previous message count per ticket to trigger Web Audio API chime
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      // Check for new admin messages to play audio chime
      tks.forEach(ticket => {
